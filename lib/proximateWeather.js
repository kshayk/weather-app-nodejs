...
var proximateWeather = function (open_weather_body, longitude, latitude) {
    const proximate_weather_api_endpoint = `https://api.darksky.net/forecast/${process.env.DARKSKY}/{lat},{lon}`;
    ...
    return new Promise((resolve, p_error) => {
        request({
            ...
            if(w2_error) {
                ...
                //get icon for now weather
                now_icon = weather_data[0].icon;
